...
void TestProductionBaselineAndResolvedLocations()
{
    ...
    Require(first.semanticReads[1].location.address == 40029U, "Mode read is wrong");
    Require(first.semanticReads[2].pointName == "fanSpeed", "FanSpeed order is unstable");
